        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(repo_block::Column::Cid)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(repo_block::Column::RepoRev)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(repo_block::Column::Size)
                            .big_integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(repo_block::Column::Content)
                            .blob()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(record::Column::Uri)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(record::Column::Collection)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(record::Column::IndexedAt)
                            .timestamp()
                            .not_null(),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(blob::Column::CreatedAt)
                            .timestamp()
                            .not_null(),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(record_blob::Column::BlobCid)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(record_blob::Column::RecordUri)
                            .string()
                            .not_null(),
                    )
                    .primary_key(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(account_pref::Column::Name)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(account_pref::Column::ValueJson)
                            .string()
                            .not_null(),
                    )
                    .to_owned(),
