use super::types::{CompatibleOp, CompatibleOpOrTombstone, Operation, Service};
use anyhow::Result;
...
mod tests {
    ...
    fn test_key() -> SecretKey {
        SecretKey::from_slice(
            &hex::decode("9d5907143471e8f0e8df0f8b9512a8c5377878ee767f18fcf961055ecfc071cd")
                .unwrap(),
        )
        .unwrap()
    }
    ...
    #[test]
    fn ensure_http_prefix_defaults_to_https_for_unprefixed_input() {
        assert_eq!(
            ensure_http_prefix("localhost:2583".to_string()),
